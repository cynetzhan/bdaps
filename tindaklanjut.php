...
include 'koneksi.php';
$kode = $_GET['kode'];
$valid = "update tabel_bdaps set bersekolah = '1' where kode = '$kode'";
   ...
   <div class="col-sm-10">
	...
	if($query){ ?>
	 <div class="panel panel-success">
      ...
      <div class="panel-body">Berhasil update data! <a href="profil.php?kode=<?php echo $kodek ?>">Lihat data</a></div>
     </div>
	<?php } else { ?>
	 <div class="panel panel-danger">
      <div class="panel-heading">Gagal!</div>
      <div class="panel-body">Gagal update data! <a href="input.php">Kembali</a></div>
     </div>
	<?php } ?>
	</div>
